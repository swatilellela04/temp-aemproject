...
describe('AEM Forms OOTB Content Tests', () => {
    ...
    describe.skip('DataSource Tests', () => {
        let dataSources = [
            ...
            confPath = '/conf/aem-training-site/settings/cloudconfigs/fdm',
    ...
    describe('Form Data Model Tests', () => {
        ...
        let formDataModels = [
            ...
            basePath = 'aem/fdm/editor.html/content/dam/formsanddocuments-fdm/aem-training-site',
    ...
    describe('AEM Forms Templates E2E Testing', () => {
        let templates = [
                {path : '/conf/aem-training-site/settings/wcm/templates/basic-af', isBlankForm : false, verificationRuleFilePath : '../../rules/template-rules.json'},
                {path : '/conf/aem-training-site/settings/wcm/templates/blank-af', isBlankForm : true}
            ],
            tabbedLayoutCount = 0,
    ...
    describe('Theme testing', () => {
        const getThemePath = (theme) => '/content/dam/formsanddocuments-themes/aem-training-site/' + theme + '/jcr:content?wcmmode=disabled';
    ...
    describe('DataLayer testing', () => {
        ...
        const templatePath = '/conf/aem-training-site/settings/wcm/templates/blank-af-v2';
